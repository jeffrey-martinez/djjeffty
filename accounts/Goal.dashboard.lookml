...
- dashboard: goal_udd
  ...
  layout: newspaper
  description: ''
  preferred_slug: Jm7GeKNnniU91XG9VWxM4I
  elements:
  - title: All BF Accounts
    ...
    limit: 500
    dynamic_fields:
    - table_calculation: personal_savings
      ...
      expression: coalesce(${reg_savings.avg_balance}, offset(${reg_savings.avg_balance},1),
        ...
        offset(${reg_savings.avg_balance},4))
      value_format:
      value_format_name: usd
      _kind_hint: measure
      _type_hint: number
    - table_calculation: dj_savings
      label: DJ Savings
      expression: coalesce(${djsavings.avg_balance}, offset(${djsavings.avg_balance},1),
        offset(${djsavings.avg_balance},2), offset(${djsavings.avg_balance},3))
      value_format:
      value_format_name: usd
      _kind_hint: measure
      _type_hint: number
    - table_calculation: dj_checking
      label: DJ Checking
      ...
      _kind_hint: measure
      _type_hint: number
    - table_calculation: personal_checking
      label: Personal Checking
      expression: coalesce(${reg_checking.avg_balance}, offset(${reg_checking.avg_balance},1),
  ...
  - title: Personal Checking YOY
    ...
    - table_calculation: personal_checking
      ...
      _kind_hint: measure
      _type_hint: number
    - table_calculation: 2018_average_balance
      label: 2018 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2018, mean(${reg_checking.avg_balance})), null)
      value_format:
      value_format_name: usd
      _kind_hint: supermeasure
      _type_hint: number
    - table_calculation: 2019_average_balance
      label: 2019 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2019, mean(${reg_checking.avg_balance})), null)
      value_format:
      value_format_name: usd
      _kind_hint: supermeasure
      _type_hint: number
  ...
  - title: DJ Checking YOY
    ...
    - category: table_calculation
      expression: coalesce(${djchecking.avg_balance}, offset(${djchecking.avg_balance},1),
        offset(${djchecking.avg_balance},2), offset(${djchecking.avg_balance},3),
        offset(${djchecking.avg_balance},4))
      label: DJ Checking
      value_format:
      value_format_name: usd
      _kind_hint: measure
    ...
    - table_calculation: 2018_average_balance
      label: 2018 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2018, mean(${djchecking.avg_balance})), null)
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: supermeasure
    ...
    - table_calculation: 2019_average_balance
      label: 2019 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2019, mean(${djchecking.avg_balance})), null)
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: supermeasure
    ...
    conditional_formatting_include_nulls: false
    hidden_fields: [reg_savings.avg_balance, djsavings.avg_balance, djchecking.avg_balance,
      reg_checking.avg_balance, personal_savings, dj_savings, personal_checking, 2018_average_balance,
      2019_average_balance]
    defaults_version: 1
    listen: {}
    row: 4
    col: 0
  ...
  - title: DJ Savings YOY
    ...
    - table_calculation: 2018_average_balance
      label: 2018 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2018, mean(${djsavings.avg_balance})), null)
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: supermeasure
    ...
    - table_calculation: 2019_average_balance
      label: 2019 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2019, mean(${djsavings.avg_balance})), null)
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: supermeasure
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: dj_savings, id: 2024
              - dj_savings, name: '2024'}, {axisId: dj_savings, id: 2023 - dj_savings,
            name: '2023'}, {axisId: dj_savings, id: 2022 - dj_savings, name: '2022'},
          {axisId: dj_savings, id: 2021 - dj_savings, name: '2021'}, {axisId: dj_savings,
            id: 2020 - dj_savings, name: '2020'}, {axisId: dj_savings, id: 2019 -
              dj_savings, name: '2019'}, {axisId: dj_savings, id: 2018 - dj_savings,
            name: '2018'}], showLabels: true, showValues: true, maxValue: 8000, valueFormat: "$0,k",
    ...
    hidden_fields: [reg_savings.avg_balance, djsavings.avg_balance, djchecking.avg_balance,
      ...
      2018_average_balance, 2019_average_balance]
    defaults_version: 1
    listen: {}
    row: 4
    col: 10
  ...
  - title: Personal Savings YOY
    ...
    - table_calculation: 2018_average_balance
      label: 2018 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2018, mean(${reg_savings.avg_balance})), null)
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: supermeasure
    ...
    - table_calculation: 2019_average_balance
      label: 2019 Average Balance
      expression: if(mod(${sequence_cal.generic_date_week_of_year}, 4) = 0, pivot_where(extract_years(${sequence_cal.generic_date_year})
        = 2019, mean(${reg_savings.avg_balance})), null)
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: supermeasure
    ...
    conditional_formatting_include_nulls: false
    hidden_fields: [reg_savings.avg_balance, djsavings.avg_balance, djchecking.avg_balance,
      reg_checking.avg_balance, personal_checking, dj_checking, dj_savings, 2018_average_balance,
      2019_average_balance]
    defaults_version: 1
    listen: {}
    row: 0
  ...
  - title: Reg S Bal
    ...
    - table_calculation: 2019_average_balance
      ...
      _type_hint: number
    - category: table_calculation
      expression: index( pivot_index(${reg_savings.avg_balance}, 1), min(match(pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${reg_savings.avg_balance}), pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${reg_savings.avg_balance}))))
      label: Current Savings Balance
      value_format:
      value_format_name: usd
      _kind_hint: supermeasure
      table_calculation: current_savings_balance
      _type_hint: number
  ...
  - title: Regular Bal
    ...
    - table_calculation: 2019_average_balance
      ...
      _type_hint: number
    - category: table_calculation
      expression: index( pivot_index(${reg_checking.avg_balance}, 1), min(match(pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${reg_checking.avg_balance}), pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${reg_checking.avg_balance}))))
      label: Current Checking Balance
      value_format:
      value_format_name: usd
      _kind_hint: supermeasure
      table_calculation: current_checking_balance
      _type_hint: number
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
  ...
  - title: DJ C Bal
    ...
    - table_calculation: current_checking_balance
      label: Current Checking Balance
      expression: index( pivot_index(${reg_checking.avg_balance}, 1), min(match(pivot_where(extract_years(${sequence_cal.generic_date_year})=2019,
      ...
      _type_hint: number
    - category: table_calculation
      expression: index( pivot_index(${djchecking.avg_balance}, 1), min(match(pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${djchecking.avg_balance}), pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${djchecking.avg_balance}))))
      label: Current DJ C Balance
      value_format:
      value_format_name: usd
      _kind_hint: supermeasure
      table_calculation: current_dj_c_balance
      _type_hint: number
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
  ...
  - title: DJ S Bal
    ...
    - table_calculation: current_checking_balance
      ...
      _type_hint: number
    - category: table_calculation
      expression: index( pivot_index(${djsavings.avg_balance}, 1), min(match(pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${djsavings.avg_balance}), pivot_where(extract_years(${sequence_cal.generic_date_year})=extract_years(now()),
        ${djsavings.avg_balance}))))
      label: Current DJ C Balance
      value_format:
      value_format_name: usd
      _kind_hint: supermeasure
  ...
  - title: Investments All Time
    name: Investments All Time
    model: Net
    explore: folio_export
    type: looker_line
    fields: [folio_export.date_week, folio_export.total_market_value, schwab_inv.avg_value]
    fill_fields: [folio_export.date_week]
    sorts: [folio_export.date_week desc]
    limit: 500
    column_limit: 50
    dynamic_fields:
    - table_calculation: contributed_amount
    ...
    - table_calculation: growth
      label: Growth
      expression: "(${folio_export.total_market_value}-${contributed_amount})/100000"
      value_format:
      value_format_name: percent_2
      _kind_hint: measure
      _type_hint: number
    - category: table_calculation
      expression: "${folio_export.total_market_value} + ${schwab_inv.avg_value}"
      label: Cumulative Value
      value_format:
      value_format_name: usd_0
      _kind_hint: measure
      table_calculation: cumulative_value
      _type_hint: number
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: folio_export.total_market_value,
            id: folio_export.total_market_value, name: Total Market Value}, {axisId: schwab_inv.avg_value,
            id: schwab_inv.avg_value, name: Avg Value}, {axisId: contributed_amount,
            id: contributed_amount, name: Contributed Amount}], showLabels: true,
    ...
    series_types:
      ...
      schwab_inv.avg_value: area
    series_colors:
      folio_export.total_market_value: "#a2dcf3"
      schwab_inv.avg_value: "#E8710A"
      contributed_amount: "#12B5CB"
    trend_lines: []
    hidden_fields: [growth, cumulative_value]
    defaults_version: 1
    listen: {}
    row: 16
    col: 5
  ...
  - title: Tomorrow's Deposit
    ...
    limit: 500
    dynamic_fields:
    - table_calculation: tomorrows_deposit
      label: Tomorrow's Deposit
      expression: (${savings_goal_2019}-${running_balance}) / diff_days(now(), to_date("2020"))
      value_format:
      value_format_name: usd
      is_disabled: false
      _kind_hint: measure
      _type_hint: number
    - table_calculation: running_balance
      label: Running Balance
      expression: |-
        19812 # starting balance
        +sum(${savtracker.sum_deposit})
      value_format:
      value_format_name: usd
      _kind_hint: measure
      _type_hint: number
    - dimension: savings_goal_2019
      label: Savings Goal 2019
      expression: '30000'
      value_format:
      value_format_name:
